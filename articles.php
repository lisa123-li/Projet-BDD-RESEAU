...
<?php
    ...
    $query = "SELECT type_appareil, puissance, description, image_path, temperature_max, technologie, e.prix
              FROM appareil_coiffure a
              JOIN article e ON a.id_mat_coif = e.reference_produit
              $orderClause";
    ...
    if (!$result) {
        ...
        while ($row = pg_fetch_assoc($result)) {
            ...
            <div class="product-card">
                ...
                <p><strong>Puissance :</strong> <?php echo htmlspecialchars($row['puissance']); ?> W</p>
                <p><strong>Température Max :</strong> <?php echo htmlspecialchars($row['temperature_max']); ?> °C</p>
                <p><strong>Technologie :</strong> <?php echo htmlspecialchars($row['technologie']); ?></p>
